> Historical documentation archive: preserved for reference only. It does not publish or migrate
> DG-MCP from this repository.
...
[![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](https://github.com/0xNullAI/DG-MCP/blob/main/LICENSE)
...
```json
{
  "mcpServers": {
    "dg-lab": {
      "command": "npx",
      "args": ["-y", "dg-mcp", "--waveforms-dir", "/path/to/wave-pack"]
    }
  }
}
```
...
[MIT](https://github.com/0xNullAI/DG-MCP/blob/main/LICENSE)
