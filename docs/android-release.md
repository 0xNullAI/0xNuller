...
当前版本使用 tag `v6.3.1`，Release 标题和 APK 都显示 `0xNuller 6.3.1`。GitHub 自动生成的
...
```bash
gh release create "v6.3.1" --repo 0xNullAI/0xNuller \
  --title "0xNuller 6.3.1" --notes-file docs/releases/6.3.1.md "$APK"
```
