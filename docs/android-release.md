...
当前发布使用 tag `android-v6.0.2`，Release 标题和 APK 也都显示 `0xNuller 6.0.2`。
...
```bash
gh release create "android-v6.0.2" --repo 0xNullAI/0xNuller \
  --title "0xNuller 6.0.2" --notes-file docs/releases/6.0.2.md "$APK"
```
