...
tag `android-v6.0.1`，Release 标题和 APK 也都显示 `0xNuller 6.0.1`。
...
```bash
gh release create "android-v6.0.1" --repo 0xNullAI/0xNuller \
  --title "0xNuller 6.0.1" --notes-file docs/releases/6.0.1.md "$APK"
```
