...
当前版本使用 tag `v6.4.0`，Release 标题和 APK 都显示 `0xNuller 6.4.0`。GitHub 自动生成的
...
```bash
gh release create "v6.4.0" --repo 0xNullAI/0xNuller \
  --title "0xNuller 6.4.0" --notes-file docs/releases/6.4.0.md "$APK"
```
