...
当前发布使用 tag `v6.0.12`，Release 标题和 APK 都显示 `0xNuller 6.0.12`。GitHub 自动生成的
...
```bash
gh release create "v6.0.12" --repo 0xNullAI/0xNuller \
  --title "0xNuller 6.0.12" --notes-file docs/releases/6.0.12.md "$APK"
```
