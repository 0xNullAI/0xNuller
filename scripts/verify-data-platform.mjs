...
// 0001-0003 recorded. Applying 0004-0008 must converge with a fresh sequential install.
...
assert(
  ...
  'auth: 0001-0003 -> 0004-0008 schema differs from fresh migration path',
);
assert(
  JSON.stringify(names(authUpgrade, 'table')) === JSON.stringify(names(auth.db, 'table')),
  'auth: 0001-0003 -> 0004-0008 tables differ from fresh migration path',
);
...
console.log(
  JSON.stringify({
    ...
    authUpgrade: '0001-0003 -> 0004-0008',
