...
/** Same seven personas as DG-Agent's `runtime/src/prompts`, rewritten for spoken brevity (short sentences, no markdown/bullet lists a TTS voice would read aloud). */
