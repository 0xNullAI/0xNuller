...
- 公开大厅、公开或私密房间、房间号与二维码邀请；邀请链接统一指向网页入口。
- 房间名必须手动填写 4–40 个字符；大厅显示在线人数，包括空房的 0 人。
- 连续 7 天无人连接后自动回收房间、聊天记录和附件，旧房间号失效；私聊不受影响。
- 文字、图片和语音消息；媒体存储于 R2。
...
历史公开房间由大厅唤醒检查；未列入大厅且没有旧定时任务的历史私密房间，在下次连接或断开后纳入新计时。
